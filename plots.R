...
air_quality <- read.csv("../Data/Scrapped/City_wise_Air_quality_2011.csv")
...
airf_qualf[5,1]='Chhattisgarh'
airf_qualf[26,1]='Tamil Nadu'
airf_qualf[22,1]='Odisha'

write.csv(air_qualf,file="../Data/Modified_Scrapped/State_wise_Air_quality_2011.csv")
